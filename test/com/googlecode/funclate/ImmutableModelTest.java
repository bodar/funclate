...
public class ImmutableModelTest extends ModelContract {
    ...
    protected Model createModel() {
        return Model.immutable.model();
    }

    @Override
    protected Model createModel(Iterable<Pair<String, Object>> values) {
        return Model.immutable.model(values);
    }
    ...
    public void canConvertToAMap() throws Exception {
        ...
        Model reversed = ImmutableModel.fromMap(root);
    ...
    public void supportsConvertingToStringAndBack() throws Exception {
        ...
        Model result = ImmutableModel.parse(serialized);
    ...
    public void shouldPreserveOrderingWhenConvertingToJson() throws Exception {
        ...
        MatcherAssert.assertThat(original, equalTo(ImmutableModel.parse(Json.toJson(original))));
    }
}
