...
public class RendererAdapterTest {
    ...
    public void supportsDifferentFormatsForAnyWrappedRenderer() throws Exception{
        RendererAdapter adapter = new RendererAdapter(returns());
        ...
        assertThat(new RendererAdapter(callingThrows()).toString("Some values", "raw"), is("Some values"));
    }

    @Test
    public void supportsChainingFormats() throws Exception{
        assertThat(new RendererAdapter(callingThrows()).toString("1 < 2", "raw,html"), is("1 &lt; 2"));
    }

    @Test
    public void supportsEmptyFormat() throws Exception{
        assertThat(new RendererAdapter(returns()).toString("1 < 2", ""), is("1 < 2"));
    }
